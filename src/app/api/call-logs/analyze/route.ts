...

{
  ...
  "resolutionStatus": "Resolved, Pending, Escalated, or Follow-up Required",
  "priority": "Low, Medium, High, or Critical",
  "csatScore": "Estimated CSAT Score from 1 to 10 based on customer satisfaction",
  "csatPercentage": "Customer Satisfaction as a percentage (0-100), based on their tone and resolution. Just the number, e.g., 85",
  ...
  "churnRisk": "Low, Medium, or High",
  "churnProbability": "Probability of the customer churning/leaving as a percentage (0-100). Just the number, e.g., 75",
